...
class Classification_Train():
    def __init__(self):
        ...
        self.train_data_dir = r'D:\xunleidownload\Oxford_102_Flowers/data/oxford-102-flowers/train.txt'
    ...
    def train(self):
        ...
        for i in range(epoch):
            ...
            with open('log/log.txt',"a+", encoding="utf-8") as f:
                f.write('epoch:{:3} train_loss:{:3f} val_loss:{:3f} train_acc:{:3f} val_acc:{:3f}\n'.format(epoch_list[i],train_loss_list[i],val_loss_list[i],train_accurate_list[i],val_accurate_list[i]))
                f.close()
